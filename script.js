  ...
  container.innerHTML = `
    <div class="next-box">
      ...
      <div class="next-actions">
        ...
        <button class="secondary-button" data-select-item-date="${next.date}">Ver no calendário</button>
      </div>
    </div>
  `;
}
...
function openItemModal(date = selectedDate, type = "compromisso") {
...
document.getElementById("itemForm").addEventListener("submit", event => {
  ...
  selectedDate = document.getElementById("itemDate").value;
  calendarCursor = dateFromISO(selectedDate);
